                                                ...
                                                <div class="flex">
                                                    <div class="form-check form-check-primary">
                                                        <input class="form-check-input" type="radio" name="color"
                                                            id="color" checked="" value="#1572e8">
                                                    </div>
                                                    <div class="form-check form-check-secondary">
                                                        <input class="form-check-input" type="radio" name="color"
                                                            id="color" value="#6861ce">
                                                    </div>
                                                    <div class="form-check form-check-info">
                                                        <input class="form-check-input" type="radio" name="color"
                                                            id="color" value="#48abf7">
                                                    </div>
                                                    <div class="form-check form-check-warning">
                                                        <input class="form-check-input" type="radio" name="color"
                                                            id="color" value="#ffad46">
                                                    </div>
                                                    <div class="form-check form-check-danger">
                                                        <input class="form-check-input" type="radio" name="color"
                                                            id="color" value="#f25961">
                                                    </div>
                                                    <div class="form-check form-check-success">
                                                        <input class="form-check-input" type="radio" name="color"
                                                            id="color" value="#31ce36">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                        ...
                                                        @foreach ($group->roles as $role)
                                                            @foreach ($role->users as $user)
                                                                <option value="{{ $user->id }}">
                                                                    {{ $user->getFullName() }} ({{ $user->role->name }})
                                                                </option>
                                                            @endforeach
                                                        @endforeach
                                                    @endforeach
                            ...
                            <div class="col-lg-6 col-md-12">
                                        ...
                                        <div class="form-check ">
                                            <div class="d-flex align-items-center">
                                                <input class="form-check-input me-2" type="radio" name="remind-rules"
                                                    value="{{ now()->addDay()->format('Y-m-d H:00:00') }}" id="tomorrow"
                                                    checked="checked">
                                ...
                                <div class="mt-3">
                                    ...
                                    <div id="recurring-rules" style="display:none;" class="mt-3">
                                        ...
                                        <div id="bymonth-select" class="btn-toolbar years-choice" role="toolbar"
                                            ...
                                            <div class="form-check mt-2 w-100">
                                                <div class="d-flex align-items-center">
                                                    <input class="form-check-input me-2" type="radio"
                                                        name="yearly-options" id="yearly-one-month" checked="checked" />
                                            ...
                                            <div class="form-check mt-3 w-100">
                                                <div class="d-flex align-items-center">
                                                    <input class="form-check-input me-2" type="radio"
                                                        name="yearly-options" id="yearly-multiple-months" />
                                            ...
                                            <div style="width: 100%">
                                                ...
                                                <input type="checkbox" class="btn btn-check"
                                                    id="yMonth{{ $key }}" name="yMonth{{ $key }}"
                                                    data-month-num="{{ $key }}" disabled="disabled">
                                    ...
                                    <div class="form-check mt-2">
                                        <div class="d-flex align-items-center">
                                            <input class="form-check-input me-2" type="radio"
                                                name="monthday-pos-select" value="month-byday-pos-selected"
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="mb-1"><b class="text-primary">Ответственный за задачу: </b> <span id="userGoal"></span>
                    </p>
                        ...
                        <div class="row mb-4 align-items-center">
                            <div class="col-lg-8 col-md-12">
                                <div class="form-check form-switch " style="font-size: 14px; font-weight: 400;">
                                    <label class="form-check-label" for="only-not-complete">Показывать только
                                        невыполненные задачи</label>
                                    <input class="form-check-input" name="only-not-complete" id="only-not-complete"
                                        type="checkbox">
                                </div>
                            </div>
