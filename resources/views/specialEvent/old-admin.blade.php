                            ...
                            <thead>
                                ...
                                <tr id="removeRow">
                                    @foreach ($headers as $index => $header)
                                        <th>
                                            <span class="btn btn-danger btn-sm remove-column-btn"
                                                attr-number="{{ $index }}">&#10006;</span>
                                        </th>
                                    @endforeach
                                ...
                                <tr>
                                    @foreach ($headers as $header)
                                        <th class="editable-cell"
                                            user_id="{{ $header['user_id'] ? $header['user_id'] : 0 }}">
