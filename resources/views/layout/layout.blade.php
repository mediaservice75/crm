                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        @if (auth()->user()->role->level <= 5)
                            <li class="sidebar-item  ">
                                <a href="{{ route('claim.activeAd') }}" class='sidebar-link align-items-center'>
                                    ...
                                    <span>Активная @if (getCountActiveAds() != 0)
                                            <br>
                                        @endif реклама </span>
                                ...
                                <a href="{{ route('claim.distribution') }}" class='sidebar-link'>
                                    ...
                                    <span>Распределение заявок
                                        @if (getCountClaimsResponsibleIsNotRead() != 0)
                                            <span
                                                class="badge bg-primary">{{ getCountClaimsResponsibleIsNotRead() }}</span>
                                        @endif
                                    </span>
                                </a>
                            </li>
                        ...
                        @if (auth()->user()->role->level <= 2 || auth()->user()->userInvoice != 0 || Auth::user()->role->level == 5)
                            <li class="sidebar-title">Бухгалтерия</li>
                                    ...
                                    <a href="{{ route('claim.invoice') }}" class='sidebar-link'>
                                        ...
                                        <span>Счета
                                            @if (getCountNotCompleteInvoice() != 0)
                                                <span
                                                    class="badge bg-primary">{{ getCountNotCompleteInvoice() }}</span>
                                            @endif
                                        </span>
                                    </a>
                                </li>
                            ...
                            <div class="header-top-right text-end">
                                <div class="dropdown">
                                    <a href="#" id="topbarUserDropdown"
                                        ...
                                        <div class="text">
                                            <h6 class="user-dropdown-name">{{ auth()->user()->surname }}
                                                {{ \Illuminate\Support\Str::substr(auth()->user()->name, 0, 1) }}.
                                                {{ \Illuminate\Support\Str::substr(auth()->user()->patron, 0, 1) }}.
                                            </h6>
                                        ...
                                        <div class="avatar avatar-md2">
                                            <img src="
                                             @if (isset(auth()->user()->photo) && !empty(auth()->user()->photo)) {{ asset('/storage') . '/' . auth()->user()->photo }}
                                        @else
                                        {{ asset('images/faces/1.jpg') }} @endif"
                                                alt="Avatar">
                                        </div>
                                    </a>
                                    <ul class="dropdown-menu dropdown-menu-end shadow-lg"
                                        aria-labelledby="topbarUserDropdown" style="">
                                        <li><a href="{{ route('users.show', ['user' => auth()->user()->id]) }}"
                                                class='dropdown-item'>Мои продажи</a></li>
                                        <li><a class="dropdown-item"
                                                href="{{ route('users.settings') }}">Настройки</a></li>
                                        <li><a class="dropdown-item" href="{{ route('users.logout') }}">Выход</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
