...
@section('page-heading')
    Управление клиентом &laquo;{{ $client->name }}&raquo; <a href="{{ route('clients.show', ['client' => $client->id]) }}"
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="inn"
                                                class="form-control @if ($errors->has('inn')) is-invalid @endif"
                                        ...
                                        <div class="form-group">
                                            <div class="form-check">
                                                <input type="checkbox" id="edo" class="form-check-input"
                                                    name="edo" value="1"
                                                    @if ($client->edo) checked @endif>
                                                <label class="form-check-label" for="edo">Работает по ЭДО</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="name"
                                                ...
                                                name="name" placeholder="Введите наименование..." required
                                                value="{{ $client->name }}">
                                            @if ($errors->has('name'))
                                                <div class="invalid-feedback">
                                                    <i class="bx bx-radio-circle"></i>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="website"
                                                ...
                                                name="website" placeholder="Введите адрес сайта..."
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="date_of_birth"
                                                ...
                                                name="date_of_birth" placeholder="Выберите дату рождения компании"
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control " id="comment" name="comment" rows="3"
                                                        placeholder="Например, дополнительные реквизиты...">{{ $client->comment }}</textarea>
                                                </div>
                                            </div>
                                        </div>
