...
@section('content')
    ...
    <form action="{{ route('claim.repeatStore', ['claim' => $claim->id]) }}" method="POST" enctype="multipart/form-data">
        @csrf

        <div class="row mt-3">
            <div class="col-12">
                <input class="form-check-input me-1" name="isInvoiceC" id="isInvoiceC" type="checkbox" value=""
                    @if ($claim->isInvoice) checked @endif> Нужен ли счет?
                <input type="hidden" name="isInvoice" value="@if ($claim->isInvoice) 1 @else 0 @endif">


                <input class="form-check-input ms-3" name="notIncludeC" id="notIncludeC" type="checkbox" value=""
                    @if ($claim->notInclude) checked @endif> Не включать в план продаж
                <input type="hidden" name="notInclude" value="@if ($claim->notInclude) 1 @else 0 @endif">

                <input class="form-check-input ms-3" name="anotherUserC" id="anotherUserC" type="checkbox" value=""
                    @if ($claim->anotherUser) checked @endif> Внештатный сотрудник
                <input type="hidden" name="anotherUser" id="anotherUser"
                    value="@if ($claim->anotherUser) 1 @else 0 @endif">
        ...
        <div class="row mt-3 d-none users-form">
            <div class="col-lg-12">
                ...
                <div class="form-group @if ($errors->has('creator')) is-invalid @endif">
                    ...
                    <select class="js-example-basic-single is-invalid" name="creator" id="creator">
        ...
        <div class="row mt-3">
            <div class="col-lg-6 col-md-12">
                <div class="form-group @if ($errors->has('group_id')) is-invalid @endif">
                    ...
                    <select class="js-example-basic-single is-invalid" name="group_id" id="group_idS">
                        <option value="">Не выбрано</option>
            ...
            <div class="col-lg-6 col-md-12">
                <div class="form-group @if ($errors->has('service_id')) is-invalid @endif">
                    ...
                    <select class="js-example-basic-single is-invalid service-group" name="service_id" id=service_id">
            ...
            <div class="col-12">
                <div class="form-group @if ($errors->has('package_id')) is-invalid @endif">
                    ...
                    <select @if (!$claim->service->isPackage) disabled="disabled" @endif
                        class="js-example-basic-single is-invalid service-package" name="package_id" id=package_id">
            ...
            <div class="col-12">
                <div class="form-group">
                    ...
                    <input type="text" id="deadlineClaim-datepicker"
                        ...
                        name="deadlineClaim-datepicker" placeholder="Выберите дату выполнения задачи..." required
            ...
            <div class="col-12 ">
                <div class="form-group">
                    ...
                    <input type="text" id="amount"
                        class="form-control @if ($errors->has('amount')) is-invalid @endif" name="amount"
                        placeholder="Введите стоимость..." value="{{ $claim->amount }}">
        ...
        <div class="col-md-12 mt-3">
            <div class="form-group">
                ...
                <textarea class="form-control @if ($errors->has('comment')) is-invalid @endif" id="comment" name="comment"
                    rows="3" placeholder="Введите дополнительный комментарий...">{{ $claim->comment }}</textarea>
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <input type="text" id="datepicker-range"
                            ...
                            name="period" placeholder="Выберите период размещения..." required
                            value="{{ $claim->period }}">
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <input type="file" id="brif"
                            class="form-control @if ($errors->has('brif')) is-invalid @endif" name="brif">
                        @if ($errors->has('brif'))
                            <div class="invalid-feedback">
                                <i class="bx bx-radio-circle"></i>
                ...
                <div class="col-12 ">
                    <div class="form-group">
                        ...
                        <input type="text" id="output"
                            class="form-control @if ($errors->has('output')) is-invalid @endif" name="output"
