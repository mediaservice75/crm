...
@section('content')
    ...
    <form action="{{ route('claims.update', ['claim' => $claim->id]) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
                                ...
                                @foreach ($claimFiles as $file)
                                    <li>
                                        <a href="{{ asset('/storage') . '/' . $file->file }}"
                                            download="file-claim">Посмотреть файл -
                                            <a class="text-danger delFile" href="#"
                                                attr-id="{{ $file->id }}">(Удалить)</a>
                                        </a>
                                    </li>
                                @endforeach
                            </ul>
